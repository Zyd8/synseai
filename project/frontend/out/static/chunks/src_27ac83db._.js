    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (userId) {
                ...
                const userRes = await fetch("".concat(API, "/api/user/").concat(userId), {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: "Bearer ".concat(token)
            ...
            // Success handling
            setModalMessage('Company "'.concat(companyData.company.name, '" ').concat(hasExistingCompany ? "updated" : "created", " successfully!"));
