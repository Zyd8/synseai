...
"[project]/src/app/bpifilesviewer/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const BpiFilesViewerPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BpiFilesViewerPage.useEffect": ()=>{
            const token = sessionStorage.getItem("access_token");
            if (!token) return;
            const fetchFiles = {
                "BpiFilesViewerPage.useEffect.fetchFiles": async ()=>{
                    setLoading(true);
                    try {
                        // 1. Get current user details
                        const userResponse = await fetch("".concat(API, "/api/user/me"), {
                            headers: {
                        ...
                        const departmentId = userData === null || userData === void 0 ? void 0 : userData.department_id;
                        if (!departmentId) {
                        ...
                        const deptResponse = await fetch("".concat(API, "/api/department/").concat(departmentId), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            }
                        ...
                        if (deptResponse.ok && (deptData === null || deptData === void 0 ? void 0 : deptData.name)) {
                            setDepartmentName(deptData.name);
                        }
                        // 3. Fetch files based on active tab
                        const url = activeTab === "all" ? "".concat(API, "/api/document_setting/included/").concat(departmentId) : "".concat(API, "/api/document_setting/current/").concat(departmentId);
                        ...
                        if (Array.isArray(data)) {
                            data = data.filter({
                                "BpiFilesViewerPage.useEffect.fetchFiles": (file)=>file.approved === false
                            }["BpiFilesViewerPage.useEffect.fetchFiles"]);
                        }
                        // ✅ Set state
                        if (activeTab === "all") {
                            setFiles(data);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DashboardSidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                    fileName: "[project]/src/app/bpifilesviewer/page.tsx",
                    lineNumber: 106,
                    columnNumber: 17
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mx-auto w-full max-w-4xl mt-6 bg-white shadow rounded-lg p-4 overflow-x-auto border border-gray-400",
...
_s(BpiFilesViewerPage, "HaXNiqnjIaTl0uUhyiChcJ/cutI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = BpiFilesViewerPage;
...
_c1 = FileTable;
const __TURBOPACK__default__export__ = BpiFilesViewerPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "BpiFilesViewerPage");
...
//# sourceMappingURL=src_fba1fd7d._.js.map