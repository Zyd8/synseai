...
// API service functions for employees
...
const createTimelineFromProposal = (proposal: any): TimelineItem[] => {
  ...
  timeline.push({
    ...
    description: `Proposal "${proposal.title}" was submitted by ${proposal.company_name || 'the company'}.`,
    status: 'SUBMITTED',
  ...
  if (currentStatus === 'ONGOING') {
    timeline.push({
      ...
      description: 'This proposal is currently under review by the BPI team.',
      status: 'ONGOING',
    ...
    timeline.push({
      ...
      time: formatTime(proposal.updated_at || proposal.created_at),
      title: 'Review In Progress',
      description: 'This proposal was under review by the BPI team.',
      status: 'ONGOING',
      created_at: proposal.updated_at || proposal.created_at
    });
    ...
    timeline.push({
      ...
      description: 'This proposal has been approved and BPI will proceed with the collaboration.',
      status: 'APPROVED',
    ...
    timeline.push({
      ...
      description: 'This proposal has been reviewed and requires further attention or modifications.',
      status: 'REJECTED',
      created_at: proposal.updated_at || proposal.created_at
    });
  }
  ...
  useEffect(() => {
    const fetchProposalData = async () => {
      try {
        ...
        console.log('BPI Proposal Tracking - Proposal ID from URL:', proposalId);
      ...
      <div className="min-h-screen bg-white flex flex-col items-center px-[10%] py-8">
        ...
        <div className="relative flex items-center w-full mt-2 mb-10">
            ...
            <div className="text-center w-full">
                ...
                <p className="text-md text-black mb-6">
                    Review and manage collaboration proposal details.
                </p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>This proposal requires further review or modifications. Follow up with the company for additional details.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="relative w-full">
                <input
                  type="text"
                  value={proposalData.company_name || 'Unknown Company'}
                  readOnly
                  className="w-full px-3 py-3 border-0 
                        bg-[#E7E7E7] text-gray-900
                        focus:outline-none text-sm sm:text-base"
          ...
          <div className="mt-6">
            ...
            <div className="relative w-full">
              <textarea
                ...
                className="w-full px-3 py-3 border-0 
                      bg-[#E7E7E7] text-gray-900
                      focus:outline-none text-sm sm:text-base resize-none"
              />
              <div className="absolute left-0 bottom-0 w-full h-[2px] bg-[#B11016]" />
            </div>
          </div>
        ...
        <div className="w-full mt-12">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600 mt-2">Track the progress of this proposal submission</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              {proposalData.timeline.length === 0 && (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-xs mt-1">Timeline will update as the proposal progresses</p>
                </div>
              )}
            </div>
          </div>
