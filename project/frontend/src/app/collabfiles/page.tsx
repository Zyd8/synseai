        ...
        <>
          <div className="min-h-screen bg-gray-50 flex flex-col items-center px-4 sm:px-[5%] lg:px-[10%] py-4 sm:py-8">
            ...
            <div className="w-full max-w-4xl mt-6 sm:mt-10 px-2 sm:px-0">
              <button className="w-full bg-[#B11016] border-2 border-transparent text-white py-3 px-6 font-bold text-sm sm:text-lg hover:bg-white hover:border-[#B11016] hover:text-[#B11016] transition-colors rounded-lg">
                UPLOAD FILES
              </button>
            </div>
          </div>
