                                        ...
                                        >
                                            ...
                                            <div className="p-8 text-center">
                                                ...
                                                <div className="relative mx-auto w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-6">
                                                    ...
                                                    />
                                                    <svg className="text-green-600 text-3xl relative z-10" fill="currentColor" viewBox="0 0 20 20">
                                                ...
                                                >
                                                    Your collaboration proposal has been successfully submitted.
                                                </motion.p>

                                                {/* Button */}
                                                <motion.button
                                                    onClick={() => router.push("/dashboard")}
                                                    className="bg-[#B11016] text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-[#800b10] transition-all duration-300 ease-in-out"
