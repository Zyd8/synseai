...
export default function BpiFiles() {
  ...
  const handleFilesClick = (settingId: number) => {
    router.push(`/filespusher?id=${settingId}`); // ✅ pass document_setting id to next page
  };
    ...
    <ProtectedRoute allowedRoles={["employee"]}>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="flex-1 py-3 sm:py-6 pl-[2%] sm:pl-[3%] pr-[3%] sm:pr-[5%] overflow-x-auto">
          <h1 className="text-2xl font-bold text-red-700">Files</h1>
